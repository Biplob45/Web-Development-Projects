...
if (!isset($_SESSION['loggedIn']) || $_SESSION['loggedIn'] != true) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $loginSql = "SELECT * FROM `bashakhali`.`users` WHERE email='$email' AND password='$password'";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link text-white" aria-current="page" href="index.php">হোম</a>
            ...
            <div class="row py-4">
                <div class="col-12">
                    <div class="w-75 mx-auto">
                        ...
                        <div class="auth-icon rounded-circle mx-auto text-center "><i class="fas fa-user-shield text-main fs-4"></i>
                        </div>

                        <?php
                        if ($isInvalid == 'true') {
                            echo "<div class='alert alert-danger my-2' role='alert'>
                            <i class='fa-solid fa-circle-exclamation'></i> ইমেইল/পাসওয়ার্ড ভুল হয়েছে
                    </div>";
                        }
                        ?>
                        <form method="post">
                            <div class="mb-3">
                                <label for="exampleFormControlInput2" class="form-label">মেইল আইডি
                                </label>
                  ...
                  " name="password" />
                                <a href="signup.php" class="mt-3">অ্যাকাউন্ট নেই? তৈরি করুন</a> <br>
                                <button class="btn btn-success my-3 px-3 fw-bold " type="submit">
                                    সাবমিট <i class="fas fa-sign-in-alt "></i></button>
                        </form>
                    </div>
                </div>
            </div>
